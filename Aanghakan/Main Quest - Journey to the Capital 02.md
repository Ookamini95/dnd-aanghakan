...
While leaving Serene behind is perfectly good ending, this campaign tries to last longer than that, and the [[Gill|merchant]] should be the npc you should use to persuade the players to take in Serene. This note has been left as a joke but also as a reminder about making a possible fork to the story if a good idea comes up. 
...
#Master-Notes Here a couple different scenarios can unfold. Below I've provided a couple of examples.
